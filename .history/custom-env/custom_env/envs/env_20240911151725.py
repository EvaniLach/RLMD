...
class Environment(gym.Env):
    ...
    def __init__(self, render_mode=None, size=5, p_path, l_path):
        ...
        self.state = self.combine_states()
    ...
    def combine_states(self):
        state = np.hstack((self.state_p, self.state_l))
        return state
